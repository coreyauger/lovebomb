...
var dep_1 = __importStar(require("./entity"));
var dep_2 = __importStar(require("./eventing"));
var dep_3 = __importStar(require("./views"));
...
(function (akkaserverless) {
    ...
    var FileOptions = /** @class */ (function (_super) {
        ...
        Object.defineProperty(FileOptions.prototype, "event_sourced_entity", {
            get: function () {
                return pb_1.Message.getWrapperField(this, dep_1.EventSourcedEntity, 1);
            },
            set: function (value) {
        ...
        Object.defineProperty(FileOptions.prototype, "value_entity", {
            get: function () {
                return pb_1.Message.getWrapperField(this, dep_1.ValueEntity, 2);
            },
            set: function (value) {
        ...
        FileOptions.prototype.serialize = function (w) {
            ...
            if (this.event_sourced_entity !== undefined)
                writer.writeMessage(1, this.event_sourced_entity, function () { return _this.event_sourced_entity.serialize(writer); });
            if (this.value_entity !== undefined)
                writer.writeMessage(2, this.value_entity, function () { return _this.value_entity.serialize(writer); });
            if (!w)
                return writer.getResultBuffer();
        };
        FileOptions.deserialize = function (bytes) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.event_sourced_entity, function () { return message.event_sourced_entity = dep_1.EventSourcedEntity.deserialize(reader); });
                        break;
                    case 2:
                        reader.readMessage(message.value_entity, function () { return message.value_entity = dep_1.ValueEntity.deserialize(reader); });
                        break;
                    default: reader.skipField();
                }
            }
    ...
    var MethodOptions = /** @class */ (function (_super) {
        ...
        Object.defineProperty(MethodOptions.prototype, "eventing", {
            get: function () {
                return pb_1.Message.getWrapperField(this, dep_2.Eventing, 1);
            },
            set: function (value) {
                pb_1.Message.setWrapperField(this, 1, value);
            },
        ...
        Object.defineProperty(MethodOptions.prototype, "view", {
            get: function () {
                return pb_1.Message.getWrapperField(this, dep_3.View, 2);
            },
            set: function (value) {
                pb_1.Message.setWrapperField(this, 2, value);
            },
        ...
        MethodOptions.prototype.serialize = function (w) {
            ...
            if (this.eventing !== undefined)
                writer.writeMessage(1, this.eventing, function () { return _this.eventing.serialize(writer); });
        ...
        MethodOptions.deserialize = function (bytes) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.eventing, function () { return message.eventing = dep_2.Eventing.deserialize(reader); });
                        break;
                    case 2:
                        reader.readMessage(message.view, function () { return message.view = dep_3.View.deserialize(reader); });
                        break;
                    default: reader.skipField();
                }
            }
    ...
    var ServiceOptions = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ServiceOptions.prototype, "entity", {
            get: function () {
                return pb_1.Message.getWrapperField(this, dep_1.EntityAssociation, 1);
            },
            set: function (value) {
                pb_1.Message.setWrapperField(this, 1, value);
            },
        ...
        ServiceOptions.prototype.serialize = function (w) {
            ...
            if (this.entity !== undefined)
                writer.writeMessage(1, this.entity, function () { return _this.entity.serialize(writer); });
            if (!w)
                return writer.getResultBuffer();
        };
        ServiceOptions.deserialize = function (bytes) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.entity, function () { return message.entity = dep_1.EntityAssociation.deserialize(reader); });
                        break;
                    default: reader.skipField();
                }
            }
